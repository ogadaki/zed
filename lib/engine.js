...
'use strict';
export function compileScript (element) {
...
export function sendEventToOutputPort (element, value) {
...
// TODO change name.
export function fireEvent2 (target, value) {
...
export function fireEvent (link, value) {
    var target = link.end.port.block;
