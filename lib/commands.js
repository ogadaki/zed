...
commands.duplicateCurrentBlock = editor.duplicateCurrentBlock;
commands.copyCurrentBlock = editor.copyCurrentBlock;
commands.pasteBlockDesc = editor.pasteBlockDesc;
...
var bindKeysForMainMode = function () {
    ...
    if (!editor.lock) {
        ...
        Mousetrap.bind('d', commands.duplicateCurrentBlock);
        Mousetrap.bind('y', commands.copyCurrentBlock);
        Mousetrap.bind('p', commands.pasteBlockDesc);
    }
    bindNonEditKeys();
};
